...
class VoiceControlManager {
    ...
    readCurrentContext() {
        ...
        switch (context) {
            case 'settings':
                message =
                    'You are in the settings panel. Available options include filters, display mode, and export functions.';
                break;
            case 'step': {
            ...
            default:
                message =
                    'You are in the main walkthrough view. Use navigation commands to move between steps and locations.';
        }
