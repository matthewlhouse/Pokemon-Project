...
class I18nManager {
    ...
    async loadTranslations() {
        try {
            ...
            console.warn(
                `Failed to load translations for ${this.locale}: ${loadError.message}, falling back to English`
            );
            try {
                ...
                this.translations =
                    sampleTranslations[this.locale] || sampleTranslations['en'] || {};
            }
        }
    }
    ...
    es: {
        pallet: {
            'oak-lab': {
                ...
                'starter-bulbasaur':
                    'Bulbasaur (Planta/Veneno) - Bueno contra los primeros dos gimnasios',
    ...
    fr: {
        pallet: {
            'oak-lab': {
                ...
                'starter-bulbasaur':
                    'Bulbizarre (Plante/Poison) - Bon contre les deux premiers arènes',
...
class TranslationPriorityManager {
    constructor() {
        this.priorities = {
            phase1: ['ui.progress', 'ui.location', 'ui.settings', 'ui.navigation'],
            phase2: ['pokemon.names', 'pokemon.types', 'items.names', 'moves.names'],
            phase3: ['locations', 'trainers', 'descriptions'],
            phase4: ['advanced-features', 'optional-content', 'flavor-text'],
        };
    }
